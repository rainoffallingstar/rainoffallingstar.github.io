...
#show: template.with(title: "生物竞赛路标系统2.0").with(lang: "zh")
...
1. 本路标系统涉及的对象为高一甚至高二学生，距离参加竞赛预计时间为一年。
2. 本系统估计学生生物英语水平为0,如你熟悉生物英语，在书单中请尽量啃最新英文原版教材，而不是翻译版。
3. 需要各种教材的电子版或纸质版(看设备与经费)，题库必用纸质版。
4. 本系统内各时间设定，检验点正解率设定并没有经过实际验证，请在实际操作中讨论并科学更改。
5. 本系统并未参考IBO大纲，请结合大纲作合理修改。
6. 慕课推荐不全面，主要是本人检验过的课程得到了推荐，其他需求请在网易公开课或其他慕课平台进行搜索。
7. 本路标系统更有利于自学，并不能对集训教学提出更多的建议，すみません！
...
4. 慕课资源网站：网易公开课
   ...
   2. [\1](https://open.163.com/special/Khan/chemistry.html)
...
与此同时，在分科做题的这个阶段也恰恰是初读和熟悉《讲义》这本书的好时机。在回顾每道题的过程中，查阅相关的教材和资料后，再到《讲义》中把相关的知识阅读一遍，将题目中涉及到而讲义中没有的知识补充上去，为后面的阶段精读讲义储备知识，打好基础。
...
串联知识点的关键是联赛真题，此阶段设定在复赛考前一个月内，使用题库为《全国中学生生物学联赛试卷解析上下册》。
