...
_When you have read the question and underlined the key words to focus your thoughts on what it is you are being asked to do, make your plan and then make brief notes in the form of words and phrases to help you focus further and decide what is relevant from your overall well of knowledge and what  is not._
...
+ write in structured paragraphs, consisting of a key  sentence that expresses the main point of the  paragraph, followed by several sentences that develop  this key point, using concrete relevant examples and  references;
+ provide a continuity from paragraph to paragraph by  using linking words and phrases;
+ leave the reader with the impression that you have organised the  content in a logical, accessible and detailed manner.
