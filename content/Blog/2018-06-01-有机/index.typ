...
#show: template.with(title: "有机").with(lang: "zh")
...
CL原子，外层电子排布为：1s2 2s2 2p63s2 3p5.是卤素家族的二狗子，是不择不扣的电子抢劫犯，常常表现出偷电子的倾向，电负性极大，江湖地位仅次于每次出世都可能引起爆炸的氟老大。
...
1. 在酸性的比较中，我们更侧重于一个分子能够解离出多少H+的问题，所以，一般对于羧基来说，要考虑其侧链基团的供电子(包括形成稳定结构的电子共振模式)、吸电子来判断O-H之间极性的变化。当然一个常用的酸性比较是羧酸\>碳酸\>苯酚。
...
7. 顺反ZE异构判断，同侧Z反侧E。对象为双键结构和环状化合物。
...
3. 烯;主链含双键最长。编号靠近双键。碳原子大于10的要在碳原子数后面加碳字。
...
8. 脂,命名为X酸X脂。内脂则将脂键断开还原，命名按羧酸，然后将结尾的字样改为内脂，用希腊字母标示出原羧基所在的编号，但是并不要出现羧基字样。内氨类似此法。
9. 胺，以胺为母体。不符合系统命名法。
10. 脂肪酸，德尔塔体系编号由羧酸基团起编号和欧米伽体系由非羧酸基团端起编号。
11. 多肽，编号从N端到C端，命名为。某氨酰某氨酰.....肽。
12. 
...
\> 在平衡时，N(COO-)＝N(NH3+)，即蛋白质两性解离平衡，对于中性条件下，羧酸的解离度略大于氨基的水解程度，需要酸碱的加入来调控这些平衡。使得N(COO-)＝N(NH3+)，在此时，将此时的ph值记为pi值，所以，当ph\>pi时，蛋白质呈现酸性+，ph=pi时，蛋白质呈现中性，ph\<pi时，蛋白质呈现碱性-，在电泳中在电场力的作用下，蛋白质会移动向相应的方向。
