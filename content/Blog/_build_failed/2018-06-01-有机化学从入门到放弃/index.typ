...
BR&I，都是卤素家族的成员，都是电子抢劫惯犯，分别是卤素家族第三位和第四位顺位继承人。卤素家族的家训是，_卤素家族有电必夺。_
...
+ _在酸性的比较中，我们更侧重于一个分子能够解离出多少Ｈ＋的问题，所以，一般对于羧基来说，要考虑其侧链基团的供电子（包括形成稳定结构的电子共振模式）、吸电子来判断Ｏ－Ｈ之间极性的变化。_当然一个常用的酸性比较是羧酸>碳酸>苯酚。
+ _在碱性的比较中，一般对于氨基来说，我们更侧重于一个原子电子的多少，即它的支链上供电子基团的多少和强弱，这里的一个误区是我们常常会把苯环当做一个供电子基团，然而事实却不是这样。_
...
3.苯，C6H6，属于经典的芳香环，π电子满足4n+2规则，成环而且每个碳原子均是sp2杂化。是一个大π键的共振结构，这导致它的电子云密度在每个局部，每一个瞬间都有可能出现巨大的增大，因此亲电反应的发生势不可挡，但是对于碳原子自私的本性来说，大家平分共享远远比不上自己独自拥有，实际上他们内心极度渴望电子，这是一个极度需要电子的结构，但是他们又不断流通他们的电子，使得连接在上面的基团必然会从这个电子流动中枢得到或者释放他们的电子。_比如面对氨基时，他们毫不客气地吸收氨基中的电子。_
...
+ 确定主链，一般主链最长，按不同类型化合物而有区别。_常见的母体是一些带有侧链基团的苯，如苄基氯、苯酚，苯甲酸之类的。_
...
+ 手性碳判断，R/S构型。
   ...
   >将手性碳原子上所连四个原子或基团按 “次 序规则”由大到小排列，然后将最小的 基团 放在远离观察者方向，其余 三个基团指向观察者，则 从大到小排序为顺时针方向的为 R，逆时针为 S，其中Ｒ标示左旋。来自拉丁文左的表述，Reliquit。同理，Ｓ也是拉丁文中对右旋的词的缩写。_在判断Ｆ－投影式的时候，如果最小基团如Ｈ，在横线上，则顺时针方向的判断为Ｓ，与立体结构判断时相反，最小基团在垂直线上时则与立体判断时一致。_

+ D/L判断，对象为糖类，氨基酸。

   >以甘油醛为标准，规定右旋Ｓ构型为 D，左旋Ｒ构型为 L。 凡分子中离羰基最远的手性碳原子的构型与 D-（＋）- 甘油醛相同的糖称 D型；反之属 L 型。

+ 顺反ZE异构判断，同侧Z反侧E。对象为双键结构和_环状化合物_。

   >1）顺反命名法,_环状化合物用顺、反表示。相同或相似的原子或基因处于同侧称为顺式也称β式，处于异侧称 为反式也称α式。_
   >
...
+ 烯;主链含双键最长。编号靠近双键。碳原子大于１０的要在碳原子数后面加碳字。
+ 醇：编号离-OH起，_主链按最长＋不饱和键原则。_
...
+ 脂,命名为Ｘ酸Ｘ脂。内脂则将脂键断开还原，命名按羧酸，然后将结尾的字样改为内脂，用希腊字母标示出原羧基所在的编号，但是并不要出现羧基字样。内氨类似此法。
+ 胺，以胺为母体。不符合系统命名法。
+ 脂肪酸，德尔塔体系编号由羧酸基团起编号和欧米伽体系由非羧酸基团端起编号。
+ 多肽，编号从Ｎ端到Ｃ端，命名为。某氨酰某氨酰.....肽。
+ 
...
+ 酮体：生物氧化中间体，丙酮，乙酰乙酸，３－羟基丁酸。

+ 羧酸：_醋酸－乙酸_，草酸－乙二酸，琥珀酸－丁二酸，安息香酸－苯甲酸，酞酸－邻苯二甲酸，_乳酸-2-羟基丙酸_，苹果酸，柠檬酸，异柠檬酸，水杨酸，_没食子酸-3,4,5-三羟基苯甲酸_。

+ 胺类：Ｎ－亚硝基胺（强烈致癌物），毒品。

+ 生物碱：有机酸盐：苹果酸盐、柠檬酸盐。其他：烟碱、可卡因、奎宁、秋水仙碱、吗啡、阿片。

+ 杂环：_呋喃、吡啶、咪坐、噻唑、嘧啶、嘌呤。_

   > **适当记一下这些结构式可能有用处。**

+ 常见脂肪酸等：软脂酸、硬脂肪酸、油酸、亚麻酸、花生四烯酸，甘油，卵磷脂、脑磷脂。

+ 糖类：Ｄ－甘油醛，Ｄ－葡萄糖，Ｄ－果糖，Ｄ－核糖，
...
糖类通过分子内成苷的形式脱水形成更稳定的环状结构，称为haworth式，这会造成变旋光现象。这是一种平衡_，但是注意的是haworth式没有旋光现象。_
...
- > 高温有利ｅｌｉｍｉｎａｔｅ反应的发生。
  >
  > _ＣＮ基团是一个常见的取代基，常常直接取代卤素基团。是实现链增长的一种有效方式。_

- 加成，由于双键是一个电子云密度在某一方可能出现异常增大的结构，故容易被亲电试剂进攻，根据马氏规则，亲核基团结合Ｈ少的碳，亲电基团结合Ｈ多的碳，从而完成加成反应。_但是在含有过氧化物Ｒ-O-O-R的体系中，按照反马氏规则进行加成。_
...
卤代烃;H+环境下，ｓｎ１、ｅ１．OH-环境下，sn2/e2.不饱和键的位置与形成ｐ－π共轭对ｅ反应不利。与金属反应_（在反应介质为无水乙醚中）_，形成c-m化合物，例如Ｇ试剂RmgX,连接ｍｇ的碳原子成负电荷，卤素原子显负电荷。宜放置在干燥的地方，以防止爆炸。



_对于ＲmgX化合物，加入ＣＯ２即α－Ｃ成酮，在加水成羧酸。_



_从空间位阻效应来看，叔丁基卤代烃是空间位阻最大的。故极难发生sn2反应。_



_硝酸银的醇溶液_，_常用于鉴别醇和卤代烃。_生成卤化银沉淀；不同结构的卤代烃生成沉淀的速度不同， 叔卤代烃和烯丙式卤代烃最快，仲卤代烃次之，伯卤代烃需加热才出现沉淀。 
...
苯酚：酸性中和反应。亲电取代（卤素：苯酚与溴水生成三溴苯酚白色沉淀，硝化，磺化）。氧化。与三氯化铁显色。_在这个苯环上碳原子从来不会形成正碳离子。_
...
醛酮：c=o的反应：sn2,与Hcn反应。sn1,_在无水酸存在下发生醇缩醛加成反应并脱水，这也是在有机合成中保护酮基的一种必要手段_；与水发生反应，不稳定，如侧链具有强吸电子基团则可形成稳定水合物；与Ｇ试剂反应，链增长；_与羰基试剂(2，4- 二硝基苯肼)反应, 产生黄色或橙红色沉淀。_



_半缩醛是缩醛反应的中间生成物，为一种羟基醚化合物，一般不稳定，可以继续和一分子的醇作用，生成缩醛。_
...
氧化：_tollens试剂，银镜反应，用来鉴别酮和醛。fehling试剂，用来区分脂肪醛和芳香醛。_
...
_当羧酸的α-C上连有强吸电子基时，加热可使它较顺利地脱羧。_



羧酸衍生物：羟基酸热稳定性差，α－羟基，分子间交叉脱水；β羟基，分子内消去反应；γ羟基，成环脱水。酚酸加热脱羧。α酮酸，稀硫酸加热脱羧基，成酮，酮式分解。β酮酸，浓碱共热，成羧酸盐，酸式分解。

胺：脂肪胺可发生ｓｎ２。芳香胺可发生亲电反应，间位取代，可利用溴定量测定苯胺。_与ＨＮＯ２反应_，_伯胺_，重氮化反应，_脂肪族反应得到不稳定物质，收集到氮气_，用来分析氨基酸和多肽的量；芳香族反应得到易爆炸的重氮盐，这一重氮盐可发生ｓｎ反应，亲电反应即偶联反应。对于_仲胺_，得到**亚硝基化合物__（黄色油状物）__，有毒性。对于_叔胺_，_脂肪族得到不稳定产物_，芳香族得到对/邻硝基胺（绿色固体）。

>_重氮化反应，是一个ＮＯ－离子攻击Ｎ＋离子的过程。_
>
>_偶联反应生成对位取代的氮氮双键。_
>
>用苯磺酰氯或对甲苯磺酰氯，在 NaOH溶液中反应，伯胺生成的产物溶于 NaOH；仲胺生成的产物不溶于 NaOH溶液；叔胺不发生反应。 

糖类：成苷，在多糖中，支链为α１６苷键，直链为α１４苷键。在单糖中，自身结构变构为ｈａｗｏｒｔｈ式式时成α１４苷键。在纤维二糖中成β１４苷键。多糖水解反应中，多糖（紫色）－红糊精－无色糊精（具有还原性）－麦芽糖－葡萄糖。氧化反应：与斐林试剂显色的为还原性糖（单糖都是），不显色的为非还原性糖，如蔗糖。_利用溴水鉴别酮糖和醛糖。_稀硝酸可以把头尾的醛基和羟基都氧化成羧基。
...
+ _消去基团的方法有两种，一是利用消去反应，二是利用CN-基团取代，酸化成羧基，在利用加热脱羧基。_
+ _链增长，也有两种，一是利用格氏试剂＋co2成羧基，二是利用CN-基团取代，酸化成羧基_
