...
话说一个人写议论文的能力和分格和他的名字是相符的，例证如下：亮超的当然是很靓的，润民的自然润物细无声，杨炫的自然是炫势的典范，兰艺若兰花的文艺，冠 #link("mailto:雅一看就是穿(?!")[雅一看就是穿(?!)着文雅（张怡微的新小说叫张冠仁。。。&lt;&amp;&amp;&gt;@张怡微），根深的自然是很深很妙的装逼......凡此种种，不可胜数，所谓的字如其人，人如其名，名如其文，其实也自有它的道理。]着文雅（张怡微的新小说叫张冠仁。。。<&&>@张怡微），根深的自然是很深很妙的装逼......凡此种种，不可胜数，所谓的字如其人，人如其名，名如其文，其实也自有它的道理。)
...
所谓百花错拳：  
 ...
 “这一流拍砖比三分剑法狠毒几分，也难上几倍。这一流派的特点是东拍一点，西拍一点，把能找到的所有要害一一拍到，手法不一，轻重各异，招式更是变化多端。但是百花错拳乃是形散神不散的，主要目的是拍人不拍文，所有的矛头都指向矛盾的中心----另一位江湖侠客。仔细观察会发现每一块砖都恰到好处的累成一座七星坛，拍砖的诸葛站在七星坛上似要呼风唤雨，其实乃是为了三气周瑜。被拍的大侠知道他是要来拍自己，可是对方摆出对文不对人的面孔，一个劲的说周都督您这个有小缺点，那个有小不足，最后看来周都督一无是处，若不气死，只有拿块板砖把自己砸死。”

审题其实是对题目材料的重构组合挖掘，即重新构造，重新组合其事件元素，在重新组合中挖掘他的真正指向，他的限制条件，这其实是一个寻找-分析-结论的过程。如百花错拳所述，就把能够议论的点都找到，东拍一点，西拍一点，把能找到的所有要害一一拍到，即要明确寻找对象，矛盾关键，事件元素及材料给的议论的点，而重构分析的过程和提出观点结论的过程就是对材料做出种种界定的过程，在这个过程中，所有的矛头都指向矛盾的中心--你最后可以形成的观点。
...
真正的高手如周伯通者，还会左右手互搏，即自己心里藏了个对手，啊小龙女也会。这在议论文里不叫在作文里设置反方，而是从始至终有反方意识，注意是从始至终哟，从第一段开始就有一个反方在你心里，他有他的观点，你要做的就是驳倒他，还有证明自己的观点有道理。

接着是语言感觉的问题，情感注入的问题，这很难，就稍微提一下，典雅的有诗意的语言当然很好，但没有深厚的基础和修养这很难做到，要典雅的语言的快捷的好办法是记一些万金油，粗糙的语言也可以，但自己的喜怒情感体现一下就可以增色，同时这篇文章是真正有了你个人的情绪，自然骨肉生动了。
...
+ 准备模块：描述材料的基本情况，表达明确的观点，情感，立场，对需要（是指下文议论需要明确的概念）界定的概念进行界定，我们讲究简洁地描述并组织材料，表达观点，情感，立场要开门见山，如同降龙十八掌一样掌掌有力，开场就要有气势，才镇得住反派嘛。

+ 试探攻击模块：这一下模块有两重思路，不过都是反方意识的运用，都是意图证明他方的错误。
...
+ 全面攻击模块：这时前面初步否定了对方的观点，正是证明自己，扩大胜利果实的时候。这时，讲究多路开花的平行合击或者是步步为营的层进攻击，都是依据材料与审题的确定而言的。所以是平行结构（参考高三一班议论文结构模式破解）还是层进结构（参考亮超老师的基本结构）要因行而定。如果材料提供的是一个多元化的多角度的情景，可以采用平行结构，如果材料提供的是比较权衡的情景，可以采用层进结构，当然可以在平行结构中的某个角度里采用局部层进结构；也可以在层进结构里采用平行布局，如：从XX角度而言，他是错的，从XX角度而言，他完全错误。

+ 空中支援模块：为什么是空中火力支援呢，因为这里要跳开材料的束缚，把现实社会引进来，一个是表现大局观，二是表现时代感。当然这里还可以用“从时间长河上看......”同样可以表现大局观。这里把现实社会引进来，同时要把观点适度放到更高的层次去考虑，比如社会，比如国家。当然这要适可而止，关键是要考量观点在这个世界的实用性能够到达什么层次。

+ 鸣鼓收兵模块：重申观点，提出解决问题的方案，提出号召和愿想，表示论证的完成和完整性，可以适当炫示素材。
...
”冰炭不言，而冷热之质自明者，以其有实也。若好忠直，如冰炭之自然，则谔谔之臣，将济济而盈庭；逆耳之言，不求而自至。若德不足以配唐虞，明不足以并周公，实不可以同冰炭，虽悬重赏，忠谏之言未可致也。昔魏绛由和戎之功，蒙女乐之赐，管仲有兴齐之勋，而加上卿之礼，功勋明著，然后赏劝随之。未闻张重赏以待谏臣，悬谷帛以求尽言也。”‚

有起兴类比为一：冰炭。起兴是由外及内，是由外界的物体，景观，自然现象，类比到内在的我们心里想的观点，注意，能够兴的关键是这两者有相同之处‘。本示例中的的类比是”冰炭自然自明有实“与”君王对忠直之人的态度和臣子的能力“分别相类比的。
