...
包被
  ...
  另外一种方法是在调好ph值后，在_磁力_搅拌下,逐滴加入待标记蛋白溶液,混匀30min后继续在磁力搅拌下加入10%BSA（牛血清白蛋白）,使其终浓度为0.5%,搅拌混匀15min,再加入5%PEG20000（聚乙二醇20000）至终浓度为0.1%,再持续搅拌混匀15min,最后4℃静置过夜。
...
因此，胶体金免疫电镜技术多采用_包埋后染色,_此法有敏感性高、重复性好、节约抗体、能同步作多重标记等优点,因此它已成为目前最常用的免疫染色方法.包埋后染色的缺点主_要是标本的前期处理常使抗原失活.标本是否新鲜、固定剂和包埋剂的种类、固定时间、聚合温度、蚀刻剂的使用、抗体和金探针的纯度及稀释倍数、孵育时间等均可影响实验结果（包括切片的薄厚）。_
...
_Papers collected and analysed by ZYQ,LDY,ZYH._

_Reading reports from ZYQ,LDY._

_Recheck&edition&addition by ZYH._

_Thanks for Polina Gagarina's songs,for the songs give me so much power to come a long way._
