...
#show: template.with(title: "THE COLLECTION 考研真题回顾").with(lang: "en")
...
It’s hard to imagine that many people are dumb enough to want children just because Reese and Angelina make it look so glamorous[迷人的，富有魅力的]: most adults understand that a baby is not a haircut[发型].  _But it’s interesting to wonder if the images we see every week  of stress-free, happiness-enhancing parenthood aren’t in some small, subconscious[潜意识的] way contributing[增加，增进] to our own dissatisfactions with the actual experience,_  in the same way that a small part of us hoped getting “the Rachel” might make us look just a little bit like Jennifer Aniston.
...
In _Arizona_ _v._ _United States_, the majority overturned[撤销，击败] three of the four contested provisions[争议性条款] of Arizona’s controversial[引起争议的] plan to have state and local police enforce[执行，强制执行] federal immigration law. The Constitutional principles that Washington alone has the power to “establish a uniform Rule of Naturalization” and that federal laws precede state laws are noncontroversial[不具争议]. Arizona had attempted to fashion[塑造] state policies that ran parallel to the existing federal ones.
...
The court would be recklessly[不顾一切地，鲁莽地] modest if it followed California’s advice. Enough of the implications are discernable[可辨别的], even obvious, so that the justices can and should provide updated guidelines to police, lawyers and defendants.
...
The study found that, among prosecuted firms, those with the most comprehensive CSR programmes tended to get more lenient[宽大，慈善] penalties[惩罚].  _Their analysis ruled out the possibility that it was firms’ political influence, rather than  their CSR stand, that accounted for the leniency: Companies that contributed more   to political campaigns did not receive lower fines.[他们的分析排除了公司的政治影响力导致了宽大处理的可能（而不是他们的CSR行为）-对政治运动献金的公司并没有得到更低的罚金。]_ 
...
And interest groups ranging from postal unions to greeting-card makers exert self-interested pressure on the USPS’s ultimate overseer[监督] – Congress – insisting that whatever else happens to the Postal Service, aspects of the status quo[说] they depend on get protected. This is why repeated attempts at reform legislation have failed in recent years, leaving the Postal Service unable to pay its bills except by deferring[延迟] vital modernization.
...
If it clears the House, this measure would still have to get through the Senate – where someone is bound to[必定] point out that it amounts to the bare, bare minimum necessary to keep the Postal Service afloat[维持下去], not comprehensive reform. There’s no change to collective bargaining at the USPS, a major omission[省略，忽略] considering that personnel accounts for 80 percent of the agency’s costs. Also missing is any discussion of eliminating Saturday letter delivery. That common-sense change enjoys wide public support and would save the USPS $2 billion per year. But postal special-interest groups seem to have killed it, at least in the House. The emerging consensus[共识] around the bill is a sign that legislators are getting frightened about a politically embarrassing short-term collapse at the USPS. It is not, however, a sign that they’re getting serious about transforming the postal system for the 21st century.
