...
Compared & mixed with privious review _Death and survival of neuronal and astrocytic cells in ischemic brain injury : a role of autophagy[2011
_
]
...
!#link("01.png")[ Necrosis, apoptosis and autophagy in focal cerebral ischemia. ]
...
_ER stress:_Hypoxia activates the ER-resident translation initiation factor eIF2α and PERK, and eIF2α kinaseregulates starvation- and virus-induced autophagy. ER stress, which includes the unfolded protein response (UPR) initiated by cell stress conditions . _A major pathway of UPR is the suppression of most protein translations through the phosphorylation of eukaryotic translation initiation factor 2 subunit a (eIf2a) via the PKR-like ER kinase(PERK). Another pathway is the upregulation of the expression of ER-localized molecular chaperones, such as glucose-regulated protein 78(G RP78/Bip, a key mediator of autophagy during preconditioning ), GRP94, and other molecu-lar chaperons, such as heat shock proteins (HSPs)_. ER stress  also induces ER associated protein degradation (ERAD) to monitor and eliminate unfolded/misfolded proteins in the ER. ERAD includes the ubiquitin/proteasome pathway (ERAD I) and the autophagy/lysosomal pathway (ERAD II). When ERAD I is injured,the autophagy/lysosomal pathway functions as ERAD II to degrade abnormal protein aggregates._prolonged ER stress may activate an ER stress-dependent apoptotic  pathway by the induction of caspases-12 and CHOP (C/EBP) homologous protein,growth arrest and DNA damage inducible gene 153, GADD153)._

_Oxidative stress_ activates autophagy in dopaminergic（多巴胺型的） neuronal cell lines and cultured（培养的） primary astrocytes.mild ER stress promotes the recovery of ER functionand cell survival during subsequent lethal ischemia.

_AMPK/TSC/mTOR-dependent APL:_The AMP-activated protein kinase (AMPK) is an evolutional
...
_Beclin 1/BNIP3/SPK2/BAG1-dependent APL:_
...
_enhanced autophagy in delayed neuronal death after H-I is differentially linked to apoptosis according to the brain regions._

+ Simultaneous activation of autophagic and apoptotic mechanisms can occur
...
_Autophagy plays dual roles in determin-ing cell fate, depending on specific cell types and stimuli. It seems that physiological levels of autophagy caused by mild or moderate cerebral ischemia and/or hypoxia appear to be protective via the production of energy to prevent cell necrosis by catabolism and inhibit cell apoptosis by removing damaged mitochondria. However, high levels of autophagy caused by severe cerebral ischemia and/or hypoxia (focal cerebral isch-emia or severe HI) may lead to self-digestion and eventual cell death._

_More work is required to determine the requirements under which the activation of autophagy reflects a protective or harmful response in cerebral ischemia._
