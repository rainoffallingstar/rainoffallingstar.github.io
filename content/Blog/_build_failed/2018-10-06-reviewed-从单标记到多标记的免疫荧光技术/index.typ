...
在传统方法的一抗、二抗孵育之后，利用opal技术进行TSA信号放大，基于TSA信号增强原理的opal技术，利用HRP(辣根过氧化氢酶)作用下，荧光标记酪胺（T）成激活态（T_）之后，T× 与蛋白质上的酪氨酸残基成共价作用，而抗原抗体特异性结合属于非共价结合，作用力较小的缘故，从而利用微波加热的方式解离抗体A，从而使得抗体A能够用于下一轮的标记上，经过如此多轮反复染色循环，从而使得标记多种蛋白质在同一组织内得以实现。[3]
