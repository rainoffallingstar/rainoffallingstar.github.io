...
#show: template.with(title: "免疫胶体金电镜技术的操作与原理").with(lang: "zh")
...
超速离心法可根据不同颗粒大小的胶体金溶液选择不同转速，高速或超速离心、洗涤、过滤除菌，以较高浓度4摄氏度保存免疫胶体金备用。如有非特异性凝集则不能再使用。采用离心法时,一般颗粒10nm以上的胶体金可高速离心,颗粒小于10nm的胶体金要用超速离心,如以牛血清蛋白的稳定的胶体金标记羊抗兔I g G，先低速离心(2 0 n m颗粒，用25×ｇ，５ｎｍ用4 8 0 0 x g)２０m in，弃去聚集的胶体金颗粒的沉淀，然后取上清液以6 0 0 0 0×ｇ(５n m)或14 000 x g(２０n m)在4°ｃ离心１h弃去上清，将沉淀以原体积的0．02 M PBS PH８．２(内含1%ＢＳＡ）溶解,如上重复离心三次，最后将沉淀溶解于原体积十分之一的上述P B S中，以0.5mg/ml的叠氮钠防腐,置4℃保存。
  ...
  用不同方法制备的胶体金根据颗粒大小需采用不同的离心力和离心时间如以白磷还原法制备的5．９nm胶体一A蛋白,用125000g。抗坏血酸法制备的11.3nm胶体金一A蛋白用5 0 0 0 0 x g,拘摊酸钠还原法制备的15.5 n m胶体金一A蛋白用15000 x g离心45 m in，为了得到颗粒均匀一致的免疫胶体，可根据lS ot所建议的用10~30%蔗糖或甘油溶液作密度梯度离心，分带收集不同大小颗粒的胶体金标记蛋白制剂，此法不仅具有制备量大操作简便和获得率高等优点而且纯化的胶体金标记抗体颗粒直径均一性好。
...
因此，胶体金免疫电镜技术多采用\包埋后染色,\此法有敏感性高、重复性好、节约抗体、能同步作多重标记等优点,因此它已成为目前最常用的免疫染色方法.包埋后染色的缺点主要是标本的前期处理常使抗原失活.标本是否新鲜、固定剂和包埋剂的种类、固定时间、聚合温度、蚀刻剂的使用、抗体和金探针的纯度及稀释倍数、孵育时间等均可影响实验结果（包括切片的薄厚）。
