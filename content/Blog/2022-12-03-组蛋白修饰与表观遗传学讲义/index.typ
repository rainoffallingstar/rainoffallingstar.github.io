...
- _概念：_ 基因的DNA序列不发生改变的情况下，基因的表达水平与功能发生改变，并产生可遗传的表型。不依赖于DNA序列的遗传现象。
  _ 特征: _ (1)可遗传，(2)可逆性，(3)DNA不变
...
+ RNA sequence/Genemicro array
  
+ Idendification of target genes of ncRNA
  
+ Functional analysis of target genes in the related diseases
...
+ 泛素激活/活化酶（E1） E1与泛素形成一个硫酯键，依赖于ATP，激活泛素分子后将其送到E2上
  
+ 泛素偶联酶（E2）E2与泛素结合，“泛素载体蛋白”，把泛素分子绑在被降解的蛋白质底物上。
  
+ 泛素连接酶（E3）E3在泛素羧基末端和底物蛋白赖氨酸残基的ε氨基之间形成异肽键，辨认被降解的蛋白质。
...
===== _免疫蛋白酶体PA28αβ-iCP immunoproteasome/PA28γ_
...
+ H2A-specific: RING1A/RING1B/BMI1; BRCA1/BARD1 ;2A-HUB
  
+ H2B-specific: RNF20/RNF40 ; BAP250b/Elo; BC/CUL2/RBX1; Brel/Rad6
  

DUB:

+ H2A-specific: USP16; USP21 ;BAP1; 2A-HUB
  
+ Common to H2A/H2B: USP3; USP12/46 ; USP22
  
+ H2B-specific: USP7; SCNY; Ubp8; Ubp10
...
+ 比如乳腺癌治疗药物氟维司群可以降解雌激素受体；
  
+ 来那多胺可以特异性降解转录因子IKZF1和IKZF3；
  
+ 第三代EGFR抑制剂奥希替尼也能选择性诱导EGFR-T790M的降解。这些意外的发现没有普适性，也较难通过合理设计来得到。
...
=== _04 泛素化的研究方法与常用实验技术_

 _常用试剂_：MG132; CHX; 表达质粒（Ubiquitin，因子，wt/mutation）

 _常用实验方法_：Western blot and immunoprecipitations

通过免疫共沉淀方法将某一特定蛋白以及与其结合的蛋白分离出来。分离出来的蛋白再进行SDS电泳和western blot分析。这一方法可以明确具体哪个蛋白的哪个赖氨酸残基发生了泛素化修饰。

 _常用抗体_：Anti-Ubiquitin; anti-Ubiquitin, Lys63 specific; anti-Ubiquitin, Lys48 specific; antiH2B K120Ub； anti-H2A K119Ub…
