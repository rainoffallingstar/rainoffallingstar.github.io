...
#show: template.with(title: "新冠肺炎预试验").with(lang: "zh")
...
2. 模型搭建与预训练：基于Tensorflow2.4 实现了经典mobilenet模型，并实现tensorboard可视化。集成在IMAGEnet数据集下预训练的模型。
   ...
   | inverted_residual_6 (ReLU6)   | None,16,16,64   | 2      | 3\3\3264         |
   ...
   | inverted_residual_10 (Linear) | None,16,16,96   | 1      | 1  \ 1 \6496     |
   ...
   | inverted_residual_16 (Linear) | None,8,8,320    | 1      | 1\1\160320       |
   | Conv (ReLU6)                  | None,8,8,1280   | 1      | 1\1\3201280      |
   | Global average pooling        | None,1280       | 1      | Pool 88          |
